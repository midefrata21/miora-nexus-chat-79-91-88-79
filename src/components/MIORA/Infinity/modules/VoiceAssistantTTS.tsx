...
export const VoiceAssistantTTS: React.FC<ModuleProps> = ({ module }) => {
      ...
      <CardContent className="space-y-3">
        ...
        <div className="text-xs text-gray-400 space-y-1">
          <div className="flex items-center">
            ...
            Voice Quality: {module.performance > 85 ? 'Excellent' : 'Good'}
          </div>
          <div>Language: Indonesian</div>
          <div>Response Time: {200 - Math.floor(module.performance)}ms</div>
        </div>
      </CardContent>
    </Card>
  );
