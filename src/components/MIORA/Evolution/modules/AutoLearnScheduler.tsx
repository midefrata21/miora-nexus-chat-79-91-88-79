...
interface AutoLearnSchedulerProps {
  module: {
    id: string;
    name: string;
...
export const AutoLearnScheduler: React.FC<AutoLearnSchedulerProps> = ({ module }) => {
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-orange-300">{module.progress.toFixed(1)}%</span>
          </div>
        ...
        <div className="space-y-2">
          <h4 className="text-orange-300 text-sm font-medium">Learning Activities:</h4>
          <div className="space-y-1 text-xs">
            ...
            <div className="p-2 bg-orange-900/20 rounded border border-orange-500/20">
              🤖 Auto-training execution
            </div>
          </div>
        </div>

        <div className="space-y-2">
          <h4 className="text-orange-300 text-sm font-medium">Dependencies:</h4>
