...
interface ConnectivityExpanderProps {
  module: UpgradeModule;
}

export const ConnectivityExpander: React.FC<ConnectivityExpanderProps> = ({ module }) => {
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-purple-400 font-bold">{module.progress.toFixed(0)}%</span>
          </div>
          ...
          <p className="text-xs text-gray-400">
            Memperluas konektivitas sistem dengan platform eksternal dan meningkatkan integrasi
          </p>
        </div>
      </CardContent>
    </Card>
