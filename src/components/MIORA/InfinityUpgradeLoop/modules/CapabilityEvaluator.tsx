...
interface CapabilityEvaluatorProps {
  module: UpgradeModule;
}

export const CapabilityEvaluator: React.FC<CapabilityEvaluatorProps> = ({ module }) => {
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-blue-400 font-bold">{module.progress.toFixed(0)}%</span>
          </div>
          ...
          <p className="text-xs text-gray-400">
            Mengevaluasi kemampuan sistem secara real-time dan mengidentifikasi area untuk peningkatan
          </p>
        </div>
      </CardContent>
    </Card>
